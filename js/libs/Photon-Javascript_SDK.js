    ...
    var Logger = /** @class */ (function () {
      ...
      Logger.prototype.exception = function (code, mess) {
        ...
        if (
          ...
          Logger.exceptionHandler(code, this.format0(mess, optionalParams))
        ) {
          return
        }
          ...
          if (typeof console !== 'undefined' && msg !== undefined) {
            try {
              ...
              if (logMethod) {
                logMethod.apply(
                  console,
                  [this.prefix, msg].concat(optionalParams)
                )
              }
            } catch (error) {
              // silently fail
...
;(function (Photon) {
  ...
  ;(function (ConnectionProtocol) {
    ...
    (ConnectionProtocol =
      Photon.ConnectionProtocol || (Photon.ConnectionProtocol = {}))
  )
  ...
  var PhotonPeer = /** @class */ (function () {
    ...
    /**
        ...
        */
    PhotonPeer.prototype.sendOperation = function (
      code,
      data,
      sendReliable,
      channelId
    ...
    /**
        ...
        */
    PhotonPeer.prototype.addPeerStatusListener = function (
      statusCode,
      callback
    ) {
    ...
    /**
        ...
        */
    PhotonPeer.prototype.addResponseListener = function (
      operationCode,
      callback
    ) {
      this._addListener(
    ...
    /**
        ...
        */
    PhotonPeer.prototype.removePeerStatusListener = function (
      statusCode,
      callback
    ) {
    ...
    /**
            ...
            @param {Function} callback Listener to remove.
        */
    PhotonPeer.prototype.removeResponseListener = function (
      operationCode,
      callback
    ) {
    ...
    /**
        ...
        */
    PhotonPeer.prototype.removePeerStatusListenersForCode = function (
      statusCode
    ) {
    ...
    /**
        ...
        */
    PhotonPeer.prototype.removeResponseListenersForCode = function (
      operationCode
    ) {
    ...
    PhotonPeer.prototype._dispatchEvent = function (code, args) {
      if (
        !this._dispatch(this._eventListeners, code.toString(), args, 'event')
      ) {
    ...
    PhotonPeer.prototype._encode = function (messages) {
      var ret = '',
        message,
        messages = Exitgames.Common.Util.isArray(messages)
          ? messages
          : [messages]
      for (var i = 0, l = messages.length; i < l; i++) {
        message =
          messages[i] === null || messages[i] === undefined
            ? ''
            : this._stringify(messages[i])
      ...
      if (this.keepAliveTimeoutMs >= 1000) {
        this.keepAliveTimer = setTimeout(function () {
          ...
          _this._send(
            ((_a = {}),
            (_a['irq'] = 1),
            (_a['vals'] = [1, Date.now() - _this.initTimestamp]),
            _a),
            true
          )
    ...
    PhotonPeer.prototype._dispatch = function (
      listeners,
      code,
      args,
      debugType
    ...
    PhotonPeer.prototype._removeListener = function (
      listeners,
      code,
      callback
    ) {
  ...
  ;(function (LoadBalancing) {
    ...
    var Actor = /** @class */ (function () {
      ...
      Actor.prototype.getRoom = function () {
        return this.loadBalancingClient
          ? this.loadBalancingClient.myRoom()
          : null
      }
      /**
      ...
      /**
            ...
            */
      Actor.prototype.onPropertiesChange = function (
        changedCustomProps,
        byClient
      ) {}
      /**
      ...
      /**
            ...
            */
      Actor.prototype.setCustomProperty = function (
        name,
        value,
        webForward,
        expectedValue
      ...
      /**
            ...
            */
      Actor.prototype.setCustomProperties = function (
        properties,
        webForward,
        expectedProperties
      ) {
      ...
      Actor.prototype._updateFromProps = function (props) {
        if (props) {
          this.name = this.updateIfExists(
            this.name,
            LoadBalancing.Constants.ActorProperties.PlayerName,
            props
          )
          var changedProps = {}
          for (var k in props) {
    ...
    var RoomInfo = /** @class */ (function () {
      ...
      /**
            ...
            */
      RoomInfo.prototype.onPropertiesChange = function (
        changedCustomProps,
        byClient
      ) {}
      /**
      ...
      /**
                ...
                @returns {object} Property or default value if property not found.
            */
      RoomInfo.prototype.getCustomPropertyOrElse = function (
        prop,
        defaultValue
      ) {
        return Exitgames.Common.Util.getPropertyOrElse(
      ...
      RoomInfo.prototype._updateFromProps = function (props) {
        if (props) {
          ...
          this.removed = this.updateIfExists(
            this.removed,
            LoadBalancing.Constants.GameProperties.Removed,
            props
          )
          ...
          this.emptyRoomLiveTime = this.updateIfExists(
            ...
            LoadBalancing.Constants.GameProperties.EmptyRoomTtl,
            props
          )
    ...
    var Room = /** @class */ (function (_super) {
      ...
      /**
                ...
                @param {object} [expectedValue] Property value expected when update occurs. (CAS : "Check And Swap")
            */
      Room.prototype.setCustomProperty = function (
        name,
        value,
        webForward,
        expectedValue
      ...
      /**
                ...
                @param {object} [expectedProperties] Table of properties expected when update occurs. (CAS : "Check And Swap")
            */
      Room.prototype.setCustomProperties = function (
        properties,
        webForward,
        expectedProperties
      ) {
       ...
       */
      Room.prototype.setSuspendedPlayerLiveTime = function (
    ...
    var LoadBalancingClient = /** @class */ (function () {
      ...
      function LoadBalancingClient(protocol, appId, appVersion) {
        ...
        this.userId = ''
        this.userAuthType =
          LoadBalancing.Constants.CustomAuthenticationType.None
      ...
      /**
            ...
            */
      LoadBalancingClient.prototype.onOperationResponse = function (
        errorCode,
        errorMsg,
        code,
        content
      ...
      /**
            ...
            */
      LoadBalancingClient.prototype.onEvent = function (
        code,
        content,
        actorNr
      ) {}
      ...
      /**
            ...
            */
      LoadBalancingClient.prototype.onRoomListUpdate = function (
        rooms,
        roomsUpdated,
        roomsAdded,
        roomsRemoved
      ...
      /**
            ...
            */
      LoadBalancingClient.prototype.onActorPropertiesChange = function (
        actor
      ) {}
      /**
      ...
      /**
            ...
            */
      LoadBalancingClient.prototype.onFindFriendsResult = function (
        errorCode,
        errorMsg,
        friends
      ) {}
      /**
            ...
            */
      LoadBalancingClient.prototype.onLobbyStats = function (
        errorCode,
        errorMsg,
        lobbies
      ) {}
      /**
            ...
            */
      LoadBalancingClient.prototype.onAppStats = function (
        errorCode,
        errorMsg,
        stats
      ) {}
      /**
            ...
            */
      LoadBalancingClient.prototype.onGetRegionsResult = function (
        errorCode,
        errorMsg,
        regions
      ) {}
      /**
            ...
            */
      LoadBalancingClient.prototype.onWebRpcResult = function (
        errorCode,
        message,
        uriPath,
        resultCode,
      ...
      /**
            ...
            */
      LoadBalancingClient.prototype.actorFactory = function (
        name,
        actorNr,
        isLocal
      ) {
      ...
      LoadBalancingClient.prototype.actorFactoryInternal = function (
        name,
        actorNr,
        isLocal
      ) {
      ...
      /**
                ...
                @param {string} address New address and port.
            */
      LoadBalancingClient.prototype.setMasterServerAddress = function (
        address
      ) {
      ...
      /**
            ...
            */
      LoadBalancingClient.prototype.setCustomAuthentication = function (
        authParameters,
        authType,
        authData
      ) {
      ...
      LoadBalancingClient.prototype.connectToNameServer = function (options) {
        ...
        if (
          ...
          this.nameServerPeer = new NameServerPeer(
            this,
            this.connectionProtocol,
            this.nameServerAddress,
            ''
      ...
      LoadBalancingClient.prototype.fillCreateRoomOptions = function (
        op,
        options
      ) {
        options = options || {}
        ...
        if (options.isVisible !== undefined)
          gp[LoadBalancing.Constants.GameProperties.IsVisible] =
            options.isVisible
        if (options.isOpen !== undefined)
          gp[LoadBalancing.Constants.GameProperties.IsOpen] = options.isOpen
        if (options.maxPlayers !== undefined)
          gp[LoadBalancing.Constants.GameProperties.MaxPlayers] =
            options.maxPlayers
        if (options.propsListedInLobby !== undefined)
          gp[LoadBalancing.Constants.GameProperties.PropsListedInLobby] =
        ...
        if (options.emptyRoomLiveTime !== undefined)
          op.push(
            LoadBalancing.Constants.ParameterCode.EmptyRoomTTL,
            Photon.TypeExt.Int(options.emptyRoomLiveTime)
          )
        if (options.suspendedPlayerLiveTime !== undefined)
          op.push(
            LoadBalancing.Constants.ParameterCode.PlayerTTL,
            Photon.TypeExt.Int(options.suspendedPlayerLiveTime)
          )
        if (options.plugins !== undefined)
          op.push(
            LoadBalancing.Constants.ParameterCode.Plugins,
            Photon.TypeExt.String(options.plugins)
          )
      ...
      /**
                ...
                @property {Photon.LoadBalancing.Constants.LobbyType} [options.lobbyType=LobbyType.Default] Type of the lobby.
            */
      LoadBalancingClient.prototype.createRoomFromMy = function (
        roomName,
        options
      ) {
      ...
      LoadBalancingClient.prototype.copyCreateOptionsFromMyRoom = function (
        options
      ) {
        options = options || {}
        ...
        options.suspendedPlayerLiveTime =
      ...
      /**
            ...
            */
      LoadBalancingClient.prototype.joinRoom = function (
        roomName,
        options,
        createOptions
      ) {
        ...
        if (options) {
          if (options.createIfNotExists) {
            op.push(
              ...
              LoadBalancingClient.JoinMode.CreateIfNotExists
            )
          ...
          if (options.rejoin) {
            op.push(
              LoadBalancing.Constants.ParameterCode.JoinMode,
              LoadBalancingClient.JoinMode.RejoinOnly
            )
          }
          if (options.expectedUsers) {
            op.push(
        ...
        this.masterPeer.sendOperation(
          LoadBalancing.Constants.OperationCode.JoinGame,
          op
        )
        return true
      }
      ...
      LoadBalancingClient.prototype.joinRandomRoom = function (options) {
        ...
        if (options) {
          if (
            ...
            options.matchingType !=
              LoadBalancing.Constants.MatchmakingMode.FillRoom
          ) {
          ...
          if (options.expectedCustomRoomProperties != undefined) {
            for (var k in options.expectedCustomRoomProperties) {
              expectedRoomProperties[k] =
                options.expectedCustomRoomProperties[k]
              propNonEmpty = true
            }
          }
          if (
            options.expectedMaxPlayers != undefined &&
            options.expectedMaxPlayers > 0
          ) {
            expectedRoomProperties[
              LoadBalancing.Constants.GameProperties.MaxPlayers
            ] = options.expectedMaxPlayers
            propNonEmpty = true
          }
          if (propNonEmpty) {
        ...
        this.masterPeer.sendOperation(
          LoadBalancing.Constants.OperationCode.JoinRandomGame,
          op
        )
        return true
      }
      LoadBalancingClient.prototype._setPropertiesOfRoom = function (
        properties,
        webForward,
        expectedProperties
      ) {
        ...
        this.gamePeer.sendOperation(
          LoadBalancing.Constants.OperationCode.SetProperties,
          op
        )
      }
      ...
      LoadBalancingClient.prototype.suspendRoom = function (options) {
        if (this.isJoinedToRoom()) {
          if (this.gamePeer) {
            ...
            this.gamePeer.sendOperation(
              LoadBalancing.Constants.OperationCode.Leave,
              params
            )
      ...
      /**
                ...
                @property {boolean} [options.webForward=false] Forward to web hook.
            */
      LoadBalancingClient.prototype.raiseEvent = function (
        eventCode,
        data,
        options
      ) {
      ...
      /**
            ...
            */
      LoadBalancingClient.prototype.changeGroups = function (
        groupsToRemove,
        groupsToAdd
      ) {
        if (this.gamePeer && this.isJoinedToRoom()) {
      ...
      /**
            ...
            **/
      LoadBalancingClient.prototype.requestLobbyStats = function (
        lobbiesToRequest
      ) {
        if (this.masterPeer && this.isConnectedToMaster()) {
          this.lobbyStatsRequestList = new Array()
      ...
      LoadBalancingClient.prototype.getRegions = function () {
        if (this.nameServerPeer && this.isConnectedToNameServer()) {
          ...
          this.onGetRegionsResult(
            LoadBalancingClient.PeerErrorCode.NameServerError,
            'Not connected to NameServer',
            {}
          )
        }
      ...
      /**
            ...
            **/
      LoadBalancingClient.prototype.webRpc = function (
        uriPath,
        parameters,
        options
      ) {
      ...
      LoadBalancingClient.prototype.createRoomInternal = function (
        peer,
        options
      ) {
        var op = []
        if (this.currentRoom.name)
          op.push(
            LoadBalancing.Constants.ParameterCode.RoomName,
      ...
      LoadBalancingClient.prototype.updateUserIdAndNickname = function (
        vals,
        logger
      ) {
      ...
      LoadBalancingClient.prototype.initNameServerPeer = function (np) {
        ...
        // errors
        np.addPeerStatusListener(
          Photon.PhotonPeer.StatusCodes.error,
          function () {
        ...
        np.addPeerStatusListener(
          Photon.PhotonPeer.StatusCodes.connectFailed,
          function () {
            _this.changeState(LoadBalancingClient.State.Error)
            _this._onErrorInternal(
        ...
        np.addPeerStatusListener(
          Photon.PhotonPeer.StatusCodes.timeout,
          function () {
            _this.changeState(LoadBalancingClient.State.Error)
            _this._onErrorInternal(
              LoadBalancingClient.PeerErrorCode.NameServerTimeout,
              'NameServer peer timeout'
            )
          }
        )
        np.addPeerStatusListener(
          Photon.PhotonPeer.StatusCodes.connecting,
          function () {}
        )
        np.addPeerStatusListener(
          Photon.PhotonPeer.StatusCodes.connect,
          function () {
        ...
        np.addPeerStatusListener(
          Photon.PhotonPeer.StatusCodes.disconnect,
          function () {
        ...
        np.addPeerStatusListener(
          Photon.PhotonPeer.StatusCodes.connectClosed,
          function () {
        ...
        np.addResponseListener(
          LoadBalancing.Constants.OperationCode.GetRegions,
          function (data) {
        ...
        np.addResponseListener(
          LoadBalancing.Constants.OperationCode.Authenticate,
          function (data) {
            ...
            if (data.errCode == 0) {
              ...
              _this.masterServerAddress =
                data.vals[LoadBalancing.Constants.ParameterCode.Address]
              np._logger.info(
                'Connecting to Master server',
                _this.masterServerAddress,
                '...'
              )
              _this.connectOptions.userAuthSecret =
                data.vals[LoadBalancing.Constants.ParameterCode.Secret]
      ...
      LoadBalancingClient.prototype.initMasterPeer = function (mp) {
        ...
        mp.addPeerStatusListener(
          ...
          function () {
            _this.changeState(LoadBalancingClient.State.Error)
            _this._onErrorInternal(
              LoadBalancingClient.PeerErrorCode.MasterTimeout,
        ...
        mp.addPeerStatusListener(
          ...
          function () {
            ...
            if (_this.connectOptions.userAuthSecret) {
              op.push(
                LoadBalancing.Constants.ParameterCode.Secret,
                _this.connectOptions.userAuthSecret
              )
              mp.sendOperation(
                LoadBalancing.Constants.OperationCode.Authenticate,
              ...
              if (
                ...
                op.push(
                  LoadBalancing.Constants.ParameterCode
              ...
              if (_this.userId) {
                op.push(
                  LoadBalancing.Constants.ParameterCode.UserId,
                  _this.userId
                )
              }
        ...
        //events
        mp.addEventListener(
          LoadBalancing.Constants.EventCode.GameList,
          function (data) {
            var gameList =
              data.vals[LoadBalancing.Constants.ParameterCode.GameList]
            _this.clearRooms()
        ...
        mp.addEventListener(
          LoadBalancing.Constants.EventCode.GameListUpdate,
          function (data) {
            var gameList =
              data.vals[LoadBalancing.Constants.ParameterCode.GameList]
          ...
          function (data) {
            ...
            if (!data.errCode) {
              ...
              if (_this.autoJoinLobby) {
                mp.sendOperation(
                  LoadBalancing.Constants.OperationCode.JoinLobby,
                  op
                )
                mp._logger.info(
                  'Join Lobby',
                  _this.connectOptions.lobbyName,
                  _this.connectOptions.lobbyType,
                  '...'
                )
              }
            } else {
        ...
        mp.addResponseListener(
          ...
          function (data) {
            ...
            _this._onOperationResponseInternal2(
              LoadBalancing.Constants.OperationCode.JoinLobby,
              data
            )
          }
        ...
        mp.addResponseListener(
          LoadBalancing.Constants.OperationCode.CreateGame,
          function (data) {
        ...
        mp.addResponseListener(
          LoadBalancing.Constants.OperationCode.FindFriends,
          function (data) {
        ...
        mp.addResponseListener(
          LoadBalancing.Constants.OperationCode.LobbyStats,
          function (data) {
            mp._logger.debug('resp LobbyStats', data)
            var res = new Array()
            if (!data.errCode) {
              var names =
                data.vals[LoadBalancing.Constants.ParameterCode.LobbyName] // not inited intentionally
              var types =
                data.vals[LoadBalancing.Constants.ParameterCode.LobbyType] || {}
              var peers =
                data.vals[LoadBalancing.Constants.ParameterCode.PeerCount] || {}
              var games =
                data.vals[LoadBalancing.Constants.ParameterCode.GameCount] || {}
              if (names) {
        ...
        mp.addEventListener(
          LoadBalancing.Constants.EventCode.LobbyStats,
          function (data) {
        ...
        mp.addEventListener(
          LoadBalancing.Constants.EventCode.AppStats,
          function (data) {
            ...
            var res = {
              ...
              masterPeerCount:
                data.vals[
                  LoadBalancing.Constants.ParameterCode.MasterPeerCount
                ],
              gameCount:
                data.vals[LoadBalancing.Constants.ParameterCode.GameCount],
            }
        ...
        mp.addResponseListener(
          LoadBalancing.Constants.OperationCode.Rpc,
          mp.webRpcHandler(this)
        )
      }
      LoadBalancingClient.prototype.connectToGameServer = function (
        masterOpCode
      ) {
      ...
      LoadBalancingClient.prototype.initGamePeer = function (gp, masterOpCode) {
        ...
        // errors
        gp.addPeerStatusListener(
          Photon.PhotonPeer.StatusCodes.error,
          function () {
            _this.changeState(LoadBalancingClient.State.Error)
            _this._onErrorInternal(
              LoadBalancingClient.PeerErrorCode.GameError,
              'Game peer error'
            )
          }
        )
        ...
        gp.addPeerStatusListener(
          ...
          function () {
            _this.changeState(LoadBalancingClient.State.Error)
            _this._onErrorInternal(
              LoadBalancingClient.PeerErrorCode.GameTimeout,
              'Game peer timeout'
            )
          }
        )
        ...
        gp.addPeerStatusListener(
          ...
          function () {
            ...
            if (!_this.gamePeerWaitingForDisconnect) {
              _this.changeState(LoadBalancingClient.State.Error)
              _this._onErrorInternal(
                LoadBalancingClient.PeerErrorCode.GameConnectClosed,
        ...
        gp.addResponseListener(
          ...
          function (data) {
            ...
            if (!data.errCode) {
              ...
              gp._logger.info('Connected')
              if (
                masterOpCode == LoadBalancing.Constants.OperationCode.CreateGame
              ) {
                ...
                if (
                  masterOpCode == LoadBalancing.Constants.OperationCode.JoinGame
                ) {
                  ...
                  if (_this.joinRoomOptions.expectedUsers) {
                    op.push(
                      LoadBalancing.Constants.ParameterCode.Add,
                      _this.joinRoomOptions.expectedUsers
                    )
                  }
                }
                gp.sendOperation(
        ...
        gp.addResponseListener(
          ...
          function (data) {
            ...
            if (!data.errCode) {
              ...
              _this.currentRoom._updateFromProps(
                data.vals[LoadBalancing.Constants.ParameterCode.GameProperties]
              )
              _this.clearActors()
        ...
        gp.addResponseListener(
          ...
          function (data) {
            ...
            if (!data.errCode) {
              ...
              _this.addActor(_this._myActor)
              var actorList =
                data.vals[LoadBalancing.Constants.ParameterCode.ActorList]
              var actorProps =
                data.vals[
                  LoadBalancing.Constants.ParameterCode.PlayerProperties
                ]
              if (actorList !== undefined) {
                for (var i = 0; i < actorList.length; i++) {
                  ...
                  if (props !== undefined) {
                    name =
                      props[LoadBalancing.Constants.ActorProperties.PlayerName]
                  }
                  var a
                  ...
                  if (props !== undefined) {
                    var userId =
                      props[LoadBalancing.Constants.ActorProperties.UserId]
        ...
        gp.addResponseListener(
          LoadBalancing.Constants.OperationCode.Rpc,
          gp.webRpcHandler(this)
        )
        // events
        gp.addEventListener(
          LoadBalancing.Constants.EventCode.Join,
          function (data) {
            gp._logger.debug('ev Join', data)
            if (
              Actor._getActorNrFromResponse(data.vals) ===
              _this._myActor.actorNr
            ) {
        ...
        gp.addEventListener(
          LoadBalancing.Constants.EventCode.Leave,
          function (data) {
        ...
        gp.addEventListener(
          LoadBalancing.Constants.EventCode.Disconnect,
          function (data) {
        ...
        gp.addEventListener(
          LoadBalancing.Constants.EventCode.PropertiesChanged,
          function (data) {
            ...
            if (targetActorNr !== undefined && targetActorNr > 0) {
              if (_this.actors[targetActorNr] !== undefined) {
                ...
                actor._updateFromProps(
                  data.vals[LoadBalancing.Constants.ParameterCode.Properties]
                )
      ...
      LoadBalancingClient.prototype._onOperationResponseInternal2 = function (
        code,
        data
      ) {
        if (data.errCode) {
      ...
      LoadBalancingClient.prototype._onErrorInternal = function (
        errorCode,
        errorMsg
      ) {
      ...
      LoadBalancingClient.prototype.checkNextState = function (
        nextState,
        dontThrow
      ) {
        if (dontThrow === void 0) {
      ...
      LoadBalancingClient.stateName =
        ...
        (_a[LoadBalancingClient.State.ConnectingToNameServer] =
          'ConnectingToNameServer'),
        (_a[LoadBalancingClient.State.ConnectedToNameServer] =
          'ConnectedToNameServer'),
        (_a[LoadBalancingClient.State.ConnectingToMasterserver] =
          'ConnectingToMasterserver'),
        (_a[LoadBalancingClient.State.ConnectedToMaster] = 'ConnectedToMaster'),
        (_a[LoadBalancingClient.State.JoinedLobby] = 'JoinedLobby'),
        (_a[LoadBalancingClient.State.ConnectingToGameserver] =
          'ConnectingToGameserver'),
        (_a[LoadBalancingClient.State.ConnectedToGameserver] =
    ...
    var LbcPeer = /** @class */ (function (_super) {
      ...
      LbcPeer.prototype.webRpc = function (uriPath, parameters, options) {
        ...
        params.push(
          LoadBalancing.Constants.ParameterCode.RpcCallParams,
          parameters
        )
        if (options) {
          if (options.sendAuthCookie) {
      ...
      LbcPeer.prototype.webRpcHandler = function (lbc) {
        ...
        return function (d) {
          ...
          if (d.errCode == 0) {
            ...
            resultCode =
              d.vals[LoadBalancing.Constants.ParameterCode.RpcCallRetCode]
          } else {
    ...
    var NameServerPeer = /** @class */ (function (_super) {
      ...
      function NameServerPeer(client, protocol, address, subprotocol) {
        var _this =
          _super.call(
            ...
            address,
            subprotocol,
            client.logger.getPrefix() + ' NameServer'
          ) || this
        _this.client = client
        return _this
      }
      ...
      NameServerPeer.prototype.opAuth = function (
        ...
        if (
          userAuthType != LoadBalancing.Constants.CustomAuthenticationType.None
        ) {
          op.push(
            LoadBalancing.Constants.ParameterCode.ClientAuthenticationType,
            Photon.TypeExt.Byte(userAuthType)
          )
          op.push(
            LoadBalancing.Constants.ParameterCode.ClientAuthenticationParams,
            userAuthParameters
          )
          if (userAuthData) {
            op.push(
              LoadBalancing.Constants.ParameterCode.ClientAuthenticationData,
              userAuthData
            )
          }
        }
    ...
    var MasterPeer = /** @class */ (function (_super) {
      ...
      function MasterPeer(client, protocol, address, subprotocol) {
        var _this =
          _super.call(
            ...
            address,
            subprotocol,
            client.logger.getPrefix() + ' Master'
          ) || this
        _this.client = client
        return _this
      }
      ...
      MasterPeer.prototype.findFriends = function (friendsToFind) {
        var params = []
        params.push(
          LoadBalancing.Constants.ParameterCode.FindFriendsRequestList
        )
    ...
    var GamePeer = /** @class */ (function (_super) {
        ...
        if (this.client.isJoinedToRoom()) {
          ...
          if (options) {
            if (
              ...
              options.receivers !== LoadBalancing.Constants.ReceiverGroup.Others
            ) {
            ...
            if (
              ...
              options.cache !== LoadBalancing.Constants.EventCaching.DoNotCache
            ) {
            ...
            if (options.interestGroup != undefined) {
              if (this.checkGroupNumber(options.interestGroup)) {
                ...
                this._logger.exception(
                  502,
                  'raiseEvent - Group not a number: ' + options.interestGroup
                )
              }
            }
          ...
          this.sendOperation(
            LoadBalancing.Constants.OperationCode.RaiseEvent,
            params
          )
        } else {
      ...
      GamePeer.prototype.changeGroups = function (groupsToRemove, groupsToAdd) {
        ...
        this.sendOperation(
          LoadBalancing.Constants.OperationCode.ChangeGroups,
          params
        )
      }
      ...
      GamePeer.prototype.checkGroupArray = function (groups, groupsName) {
        if (Exitgames.Common.Util.isArray(groups)) {
          ...
          this._logger.exception(
            504,
            'changeGroups - groupsToRemove not an array: ' + groups
          )
        }
      }
      return GamePeer
  ...
  ;(function (Chat) {
    ...
    //            @borrows Photon.LoadBalancing.LoadBalancingClient#connectToNameServer
      ...
      /**
            ...
            */
      ChatClient.prototype.onUserStatusUpdate = function (
        userId,
        status,
        gotMessage,
        statusMessage
      ...
      ChatClient.prototype.subscribe = function (channelNames, options) {
        ...
        if (this.masterPeer && this.isConnectedToFrontEnd()) {
          ...
          var params = []
          params.push(
            Chat.Constants.ParameterCode.Channels,
            Photon.TypeExt.String(channelNames)
          )
          if (options) {
            if (options.historyLength) {
              params.push(
                Chat.Constants.ParameterCode.HistoryLength,
                Photon.TypeExt.Int(options.historyLength)
              )
            }
            if (options.lastIds) {
              params.push(
                Chat.Constants.ParameterCode.MsgIds,
                Photon.TypeExt.Int(options.lastIds)
              )
              if (options.historyLength === undefined) {
                params.push(
                  Chat.Constants.ParameterCode.HistoryLength,
                  Photon.TypeExt.Int(-1)
                )
              }
            }
            if (options.createOptions) {
              if (options.createOptions.publishSubscribers) {
                if (
                  options.createOptions.maxSubscribers >
                ...
                var props = Photon.TypeExt.DictTypedKeys(
                  Photon.TypeExtType.Object,
                  Photon.TypeExtType.Object
                )
                Photon.TypeExt.PutTypedKey(
                  props,
                  Photon.TypeExt.Byte(
                    Chat.Constants.ChannelProperties.PublishSubscribers
                  ),
                  true
                )
                Photon.TypeExt.PutTypedKey(
                  props,
                  Photon.TypeExt.Byte(
                    Chat.Constants.ChannelProperties.MaxSubscribers
                  ),
          ...
          this.masterPeer.sendOperation(
            Chat.Constants.OperationCode.Subscribe,
            params
          )
          return true
        } else {
      ...
      ChatClient.prototype.unsubscribe = function (channelNames) {
        if (this.masterPeer && this.isConnectedToFrontEnd()) {
          ...
          this.masterPeer.sendOperation(
            Chat.Constants.OperationCode.Unsubscribe,
            params
          )
          return true
        } else {
      ...
      ChatClient.prototype.publishMessage = function (
        ...
        if (this.masterPeer && this.isConnectedToFrontEnd()) {
          ...
          this.masterPeer.sendOperation(
            Chat.Constants.OperationCode.Publish,
            params
          )
          return true
        } else {
      ...
      /**
            ...
            */
      ChatClient.prototype.sendPrivateMessage = function (
        userId,
        content,
        options
      ) {
        if (this.masterPeer && this.isConnectedToFrontEnd()) {
          ...
          this.masterPeer.sendOperation(
            Chat.Constants.OperationCode.SendPrivate,
            params
          )
          return true
        } else {
      ...
      /**
            ...
            */
      ChatClient.prototype.setUserStatus = function (
        status,
        statusMessage,
        skipMessage
      ) {
        ...
        if (this.masterPeer && this.isConnectedToFrontEnd()) {
          var params = []
          params.push(
            Chat.Constants.ParameterCode.Status,
            Photon.TypeExt.Int(status)
          )
          if (skipMessage)
          ...
          this.masterPeer.sendOperation(
            Chat.Constants.OperationCode.UpdateStatus,
            params
          )
          return true
        } else {
      ...
      ChatClient.prototype.addFriends = function (userIds) {
        if (this.masterPeer && this.isConnectedToFrontEnd()) {
          var params = []
          params.push(
            Chat.Constants.ParameterCode.Friends,
            Photon.TypeExt.String(userIds)
          )
          this.masterPeer.sendOperation(
            Chat.Constants.OperationCode.AddFriendds,
            params
          )
          return true
        } else {
      ...
      ChatClient.prototype.removeFriends = function (userIds) {
        if (this.masterPeer && this.isConnectedToFrontEnd()) {
          ...
          this.masterPeer.sendOperation(
            Chat.Constants.OperationCode.RemoveFriends,
            params
          )
          return true
        } else {
      ...
      // private
      ChatClient.prototype.getOrAddChannel = function (
        channels,
        name,
        isPrivate
      ) {
      ...
      ChatClient.prototype.initMasterPeer = function (mp) {
        ...
        //});
        mp.addEventListener(
          Chat.Constants.EventCode.ChatMessages,
          function (data) {
        ...
        mp.addEventListener(
          Chat.Constants.EventCode.PrivateMessage,
          function (data) {
        ...
        mp.addEventListener(
          Chat.Constants.EventCode.StatusUpdate,
          function (data) {
            var sender = data.vals[Chat.Constants.ParameterCode.Sender]
        ...
        mp.addEventListener(
          Chat.Constants.EventCode.Subscribe,
          function (data) {
            mp._logger.debug('ev Subscribe', data)
            var res = {}
            var channels =
              data.vals[Chat.Constants.ParameterCode.Channels] || []
            var results =
              data.vals[Chat.Constants.ParameterCode.SubscribeResults] || []
            var readProps = false
            var channelProperties =
              data.vals[Chat.Constants.ParameterCode.Properties]
            var subscribers =
              data.vals[Chat.Constants.ParameterCode.ChannelSubscribers]
        ...
        mp.addEventListener(
          Chat.Constants.EventCode.Unsubscribe,
          function (data) {
        ...
        mp.addEventListener(
          Chat.Constants.EventCode.UserSubscribe,
          function (data) {
            ...
            if (ch == undefined) {
              mp._logger.error(
                "UserSubscribe: channel '" + channelName + "' not found"
              )
            } else {
              if (!ch.addSubscriber(userId)) {
                mp._logger.error(
                  "UserSubscribe: channel '" +
                    channelName +
                    "' max subscribers exceeded"
                )
              }
        ...
        mp.addEventListener(
          Chat.Constants.EventCode.UserUnsubscribe,
          function (data) {
            ...
            if (ch == undefined) {
              mp._logger.debug(
                "UserUnsubscribe: channel '" + channelName + "' not found"
              )
            } else {
              if (!ch.removeSubscriber(userId)) {
                mp._logger.debug(
                  "UserUnsubscribe: subscriber '" +
                    userId +
      ...
      ChatClient.chatStateName =
        ...
        (_a[ChatClient.ChatState.ConnectingToNameServer] =
          'ConnectingToNameServer'),
        (_a[ChatClient.ChatState.ConnectedToNameServer] =
          'ConnectedToNameServer'),
        (_a[ChatClient.ChatState.ConnectingToFrontEnd] =
